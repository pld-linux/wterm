...
Wterm jest klonem rxvt stworzonym specjalnie z myślą o WindowMakerze.
Oferuje wiele interesujących funkcji, takich jak bardzo szybka obsługa
przezroczystości tła czy przezroczysty pasek przewijania typu NeXT.
